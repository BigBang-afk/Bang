...
const FALLBACK_PLANS: PlanWithFeatures[] = [
  {
    ...
    sort_order: 0,
    trial_days: 0,
    limits: { watchlists: 1, watchlist_items: 10, alerts: 3, ai_analyses_per_day: 3, journal_entries: 25, markets: ["crypto"] },
  ...
  },
  {
    ...
    sort_order: 1,
    trial_days: 7,
    limits: { watchlists: 3, watchlist_items: 50, alerts: 15, ai_analyses_per_day: 15, journal_entries: 250, markets: ["crypto", "forex"] },
    stripe_product_id: null,
    stripe_price_id_monthly: null,
    stripe_price_id_yearly: null,
    created_at: "",
  ...
  },
  {
    ...
    sort_order: 2,
    trial_days: 7,
    limits: { watchlists: 10, watchlist_items: 200, alerts: 50, ai_analyses_per_day: 50, journal_entries: null, markets: ["crypto", "forex", "gold", "indices"] },
    stripe_product_id: null,
    stripe_price_id_monthly: null,
    stripe_price_id_yearly: null,
    created_at: "",
  ...
  },
  {
    ...
    sort_order: 3,
    trial_days: 7,
    limits: { watchlists: null, watchlist_items: null, alerts: null, ai_analyses_per_day: 200, journal_entries: null, markets: ["crypto", "forex", "gold", "indices"] },
    stripe_product_id: null,
    stripe_price_id_monthly: null,
    stripe_price_id_yearly: null,
    created_at: "",
