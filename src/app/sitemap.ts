...
export default async function sitemap(): Promise<MetadataRoute.Sitemap> {
  ...
  // The database may not be reachable yet (e.g. during initial deployment
  // before Supabase env vars are configured) — never let that break the
  // build or take down sitemap.xml; just ship the static routes.
  try {
