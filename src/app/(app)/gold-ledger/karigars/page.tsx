...
export const metadata = { title: "Gold With Karigars | Zarghoon Jewellers" };

export default async function GoldWithKarigarsPage() {
  ...
  return (
    <div className="flex flex-1 flex-col gap-6 p-4 sm:p-6">
      <div>
        <h1 className="font-display text-xl font-semibold text-foreground">Gold With Karigars</h1>
