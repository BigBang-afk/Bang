...
<section class="section" style="text-align:center;">
    <div class="container" style="max-width:560px;">
        ...
        <h1>Thank You for Shopping with <?= e(SITE_NAME) ?>.</h1>

        <div class="admin-panel" style="text-align:left;margin-top:24px;">
            <dl class="account-info">
                <div><dt>Order Number</dt><dd><?= e($order['order_number']) ?></dd></div>
                <div><dt>Order Date</dt><dd><?= date('d M Y, H:i', strtotime($order['created_at'])) ?></dd></div>
                <div><dt>Total Amount</dt><dd><?= formatPrice((float) $order['total']) ?></dd></div>
