...
| 4. Networking (Photon Fusion 2) | ✅ done* (unverified against real Fusion SDK — see docs/NETWORKING.md) |
| 5. Backend (PlayFab) | ✅ done* (unverified against real PlayFab SDK — see docs/BACKEND.md) |
| 6. Economy & progression | ⏳ next |
| 7. UI system | pending |
