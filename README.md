...
- **Dashboard** – total profit/loss (USD), net PKR, net gold-equivalent, current rates, and recent entries.
...
- **Customer Ledger** – manage customers and see a running-balance statement (PKR) of every profit/loss entry for the selected customer.
