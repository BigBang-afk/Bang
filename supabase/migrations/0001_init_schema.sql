...
create table website_settings (
  ...
  about_content text not null default 'Zarghoon Jewellers is a gold and jewelry shop located in Liaquat Bazar, Sarafa Market, Quetta. We focus on quality gold jewelry, offering traditional and modern designs including bridal jewelry, gold rings, bangles, necklaces, and earrings, alongside custom jewelry orders. We aim to be transparent about weight and gold rates, and to provide attentive customer service to every visitor. (Edit this page from the admin panel to add your shop''s specific story and details.)',
  privacy_policy text not null default 'Zarghoon Jewellers respects your privacy. Information submitted through this website (such as your name, phone number, and email) is used only to respond to your inquiries, custom order requests, and to improve our service. We do not sell or share your information with third parties. Please edit this policy from the admin panel to reflect your business practices in detail.',
  terms_conditions text not null default 'By using this website and contacting Zarghoon Jewellers, you agree that product prices shown are estimates based on the current gold rate and gross weight, and are subject to confirmation at the showroom. Product availability, sizing, and final pricing are confirmed at the time of purchase. Please edit these terms from the admin panel to reflect your business policies in detail.',
