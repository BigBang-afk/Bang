...
<div class="admin-panel">
    <div class="coming-soon">
        ...
        <h2>Site Settings</h2>
        <p>Managing shop info, contact details, currency, and social links (backed by the existing <code>settings</code> table) will be available in an upcoming phase.</p>
